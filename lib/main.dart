...
class GameState extends ChangeNotifier {
  ...
  double attackPlanPower(String p)=>p=='breakthrough'?1.22:p=='cautious'?0.90:1.0;
  double attackPlanCost(String p)=>p=='breakthrough'?1.28:p=='cautious'?0.86:1.0;
  ...
  ({double attacker,double defender}) _battleLosses(double ratio,bool wonRound){final r=max(.05,ratio);return (attacker:((wonRound?0.06:.10)+(r<1?(1-r)*.12:0)).clamp(.035,.24).toDouble(),defender:((wonRound?0.13:.08)+(r>1?(r-1)*.07:0)).clamp(.04,.30).toDouble());}
